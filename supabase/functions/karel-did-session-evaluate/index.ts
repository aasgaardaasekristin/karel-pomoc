...
async function persistEvaluation(
  ...
  const reviewPayload = {
    ...
    part_name: partName,
    session_date: ctx.plan.plan_date,
    mode: ((ctx.plan.urgency_breakdown as any)?.ui_surface === "did_kids_playroom" || (ctx.plan.urgency_breakdown as any)?.session_actor === "karel_direct") ? "playroom" : "session",
    ...
    recommendations_for_next_playroom: ((ctx.plan.urgency_breakdown as any)?.ui_surface === "did_kids_playroom" || (ctx.plan.urgency_breakdown as any)?.session_actor === "karel_direct") ? evaluation.recommended_next_step ?? null : null,
