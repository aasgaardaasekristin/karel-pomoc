...
export function resolveTarget(
  ...
  switch (item.info_class) {
    ...
    case "daily_operational":
      // 05A is written by analyst-loop as full replace; individual items → DB only
      return null;

    case "strategic_outlook":
      return null; // 05B is written by dedicated cycle

    case "long_term_trajectory":
      return null; // 05C is written by dedicated cycle
    ...
    case "dashboard_signal":
      return null; // Dashboard is generated by analyst-loop
