...
function deriveCSSVars(primary: string, accent: string, dark: boolean) {
  ...
  return {
    "--background": shift(primary, { s: Math.max(8, p.s * 0.18), l: 96 }),
    "--foreground": shift(primary, { s: 10, l: 20 }),
    "--card": shift(primary, { s: Math.max(8, p.s * 0.15), l: 94 }),
    "--card-foreground": shift(primary, { s: 10, l: 20 }),
    "--popover": shift(primary, { s: Math.max(8, p.s * 0.15), l: 94 }),
    "--popover-foreground": shift(primary, { s: 10, l: 20 }),
    "--secondary": shift(accent, { s: Math.max(10, a.s * 0.18), l: 90 }),
    "--secondary-foreground": shift(primary, { s: 10, l: 24 }),
    "--muted": shift(primary, { s: Math.max(8, p.s * 0.12), l: 91 }),
    "--muted-foreground": shift(primary, { s: 8, l: 42 }),
    "--border": shift(primary, { s: Math.max(8, p.s * 0.14), l: 84 }),
    "--input": shift(primary, { s: Math.max(8, p.s * 0.14), l: 84 }),
    "--primary": shift(primary, { s: clamp(p.s * 0.78, 16, 40), l: clamp(p.l, 34, 46) }),
    "--primary-foreground": `${p.h} 18% 98%`,
    "--accent": shift(accent, { s: clamp(a.s * 0.55, 18, 42), l: clamp(a.l + 6, 64, 78) }),
    "--accent-foreground": `${a.h} 18% 22%`,
    "--ring": shift(primary, { s: clamp(p.s * 0.78, 16, 40), l: clamp(p.l, 34, 46) }),
    "--chat-user": shift(accent, { s: Math.max(10, a.s * 0.16), l: 89 }),
    "--chat-assistant": shift(primary, { s: Math.max(10, p.s * 0.18), l: 91 }),
    "--chat-border": shift(primary, { s: Math.max(8, p.s * 0.14), l: 82 }),
    ...
    "--mode-safety": `${a.h} ${clamp(a.s * 0.5, 18, 38)}% ${clamp(a.l, 58, 74)}%`,
    "--sidebar-background": shift(primary, { s: Math.max(8, p.s * 0.12), l: 93 }),
    ...
    "--sidebar-accent": shift(accent, { s: Math.max(10, a.s * 0.16), l: 88 }),
    "--sidebar-accent-foreground": shift(primary, { s: 10, l: 24 }),
    "--sidebar-border": shift(primary, { s: Math.max(8, p.s * 0.14), l: 84 }),
    "--sidebar-ring": shift(primary, { s: clamp(p.s * 0.78, 16, 40), l: clamp(p.l, 34, 46) }),
    "--theme-surface": shift(primary, { s: Math.max(8, p.s * 0.14), l: 95 }),
    "--theme-soft": shift(primary, { s: Math.max(8, p.s * 0.12), l: 92 }),
    "--theme-glow": shift(primary, { s: clamp(p.s * 0.32, 10, 28), l: 84 }),
    "--theme-glow-strong": shift(accent, { s: clamp(a.s * 0.28, 10, 26), l: 86 }),
