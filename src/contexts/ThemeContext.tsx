...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => { loadPrefs(currentPersona); }, [currentPersona, loadPrefs]);
  ...
  useEffect(() => {
    ...
    if (prefs.dark_mode) root.classList.add("dark"); else root.classList.remove("dark");
  }, [prefs]);
