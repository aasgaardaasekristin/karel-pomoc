...
export const APP_MODE_POLICIES: Record<AppModeId, AppModePolicy> = {
  karel_chat: {
    ...
    starter_questions: [
      ...
      { id: "karel-private", mode_id: "karel_chat", label: "Bez ukládání", prompt: "Chci si s tebou něco promyslet bez ukládání.", default_no_save: true, intended_write_policy: "private_only" },
    ],
  ...
  hana_osobni: {
    ...
    starter_questions: [
      ...
      { id: "hana-note-private", mode_id: "hana_osobni", label: "Poznámka bez DID", prompt: "Chci napsat poznámku, ale nechci ji ukládat do DID systému.", default_no_save: true, intended_write_policy: "private_only" },
