...
import { Mic, Keyboard, Send, Square, Pause, Play, RefreshCw, Save, Loader2, CheckCircle, RotateCcw, ArrowLeft, FileAudio, Image, PenTool } from "lucide-react";
    ...
    try {
      ...
      const { error: sessionError } = await supabase.from("client_sessions").insert({
        ...
        ai_analysis: JSON.stringify({
          ...
          diagnosticHypothesis: rec.diagnosticHypothesis || {},
          therapeuticRecommendations: rec.therapeuticRecommendations || [],
          nextSessionFocus: rec.nextSessionFocus || [],
