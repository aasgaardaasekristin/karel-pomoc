...
const PlanCard = ({
  ...
  return (
    <div className={`rounded-md border p-2.5 mt-1.5 transition-all ${lifeCycleBorder} ${
      ...
      {/* C0 SESSION-TYPE TRUTH SEPARATION (2026-04-22):
          Pravdivý titulek karty podle modality. Therapist-led nikdy nesmí
          tvrdit "Sezení s Karlem"; Karel-led nikdy nesmí tvrdit "VEDE: Hanka". */}
      <div className="mb-1 text-[12px] font-['Crimson_Pro',serif] font-medium text-foreground/85 leading-tight">
        {sessionTitle}
      </div>
